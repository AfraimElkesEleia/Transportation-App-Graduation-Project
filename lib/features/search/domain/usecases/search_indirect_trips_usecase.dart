...
class SearchIndirectTripsUseCase
    extends Usecase<PagedResultEntity<IndirectTripEntity>, SearchParams> {
  final SearchRepository repository;
  SearchIndirectTripsUseCase(this.repository);

  @override
  Future<Either<Failure, PagedResultEntity<IndirectTripEntity>>> call(SearchParams params) {
    return repository.searchIndirectTrips(params:params);
  }
}