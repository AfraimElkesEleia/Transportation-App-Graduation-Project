...
extension TransportTypeExt on TransportType {
  ...
  String get label {
    switch (this) {
      case TransportType.all:   return 'All';
...
extension SortByExt on SortBy {
  ...
  String get label {
    switch (this) {
      case SortBy.departureTime:    return 'Departure Time';
      case SortBy.lowestPrice:      return 'Lowest Price';
      case SortBy.shortestDuration: return 'Shortest Duration';
    }
  }
}
...
class SearchParams extends Equatable {
  ...
  Map<String, dynamic> toQueryParams() {
    return {
      ...
      else if (fromGovernorate != null) 'fromGovernorate': fromGovernorate,
      if (toStationId     != null) 'toStationId':     toStationId
      else if (toGovernorate   != null) 'toGovernorate':   toGovernorate,
  ...
  bool get hasTimeFilters =>
      ...
      arrivalFrom   != null || arrivalTo   != null;
  ...
  SearchParams copyWith({
    ...
    return SearchParams(
      ...
      departureFrom:     clearTimeFilters ? null : departureFrom ?? this.departureFrom,
  ...
  List<Object?> get props => [
    ...
    fromGovernorate, fromStationId,
    toGovernorate,   toStationId,
    transport, sortBy, maxPrice,
    preferredAgencies,
